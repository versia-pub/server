...
- The [Bun Runtime](https://bun.sh), version 1.1.12 or later (usage of the latest version is recommended)
  - Lysand will work on lower versions than 1.1.12, but only the latest version is supported

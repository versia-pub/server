...
- The [Bun Runtime](https://bun.sh), version 1.1.18 or later (usage of the latest version is recommended)
  - Lysand will work on lower versions than 1.1.18, but only the latest version is supported
